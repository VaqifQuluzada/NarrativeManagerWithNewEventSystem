...
namespace GTVariable.Editor
{
    ...
    public static class GameEventUtility
    {
        ...
        /// <param name="target">target game event</param>
        /// <returns></returns>
        public static List<GameEventListener> GetAssosiatedListenersInScene(EmptyGameEvent target)
        {
        ...
        /// <param name="listeners">the list to which the found listeners will be added</param>
        /// <returns></returns>
        public static void GetAssosiatedListenersInScene(EmptyGameEvent target,List<GameEventListener> listeners)
        {
